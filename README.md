...
```
git clone git@github.com:mimisha25/Members-Only-TOP.git
```
...
```
npm install bscryptjs dotenv ejs express express-session method-override passport passport-local pg uuid
```
...
"data": "node src/config/db.js",
}
```
7. Run database script to seed the initial default data:
```
npm run data
```
